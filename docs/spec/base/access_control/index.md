...
親インデックス閲覧可否(※1)<br>インデックス公開状態(※2)<br>閲覧権限の有無(※3)| システム管理者 | リポジトリ管理者 | コミュニティ管理者 | 登録ユーザー | 一般ユーザー | ゲスト(未ログイン) |
| --- | :-----------:  | :------------: |:------------: |:------------: |:------------: |:------------: |
| 親インデックス: 閲覧可  <br> インデックス: 公開  <br>閲覧権限: あり  | ◯ | ◯ | ◯ | ◯ | ◯ | ◯ |
| 親インデックス: 閲覧可  <br> インデックス: 公開 <br>閲覧権限: なし   | ◯ | ◯ | ◯ | ✕ | ✕ | ✕ |
| 親インデックス: 閲覧可  <br> インデックス: 非公開  <br>閲覧権限: あり| ◯ | ◯ | ◯ | ✕ | ✕ | ✕ |
| 親インデックス: 閲覧可  <br> インデックス: 非公開 <br>閲覧権限: なし | ◯ | ◯ | ◯ | ✕ | ✕ | ✕ |
| 親インデックス: 閲覧不可<br> インデックス: 公開  <br>閲覧権限: あり  | ◯ | ◯ | ◯ | ✕ | ✕ | ✕ |
| 親インデックス: 閲覧不可<br> インデックス: 公開<br>閲覧権限: なし    | ◯ | ◯ | ◯ | ✕ | ✕ | ✕ |
| 親インデックス: 閲覧不可<br> インデックス: 非公開<br>閲覧権限: あり  | ◯ | ◯ | ◯ | ✕ | ✕ | ✕ |
| 親インデックス: 閲覧不可<br> インデックス: 非公開<br>閲覧権限: なし  | ◯ | ◯ | ◯ | ✕ | ✕ | ✕ |
...
下記はAPIそのものへのアクセスコントロールであり、特記なき場合アイテム、インデックス、ファイル等はそれぞれへのアクセスコントロールも適用されます。
